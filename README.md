# **GTM Variable Template - Consent State (v2.0)**
...
* **Consent string override**: reads the string from the event data and falls back to the request query parameter, or takes it from any variable you supply.
...
| **Advanced → Consent string override** | Source the string from a variable instead of event data / query parameter. |
